...
data_dir = raw"/Users/ash_prabu/Downloads/Task02_Heart"
...
# ╔═╡ 0869c012-63b0-4ae7-a124-9c9aaafe942b
function compute_dtm(img)
	tfm = DistanceTransforms.SquaredEuclidean()
	dtm = DistanceTransforms.transform(img, tfm)
    return dtm
end
...
begin
	for epoch in range(1, stop=max_epochs)
		epoch_loss = 0
		step = 0
		println("Epoch: ", epoch)
